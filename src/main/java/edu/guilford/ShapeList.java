...
public class ShapeList extends ArrayList<Shape> {
    ...
    public Color getRandomColor() {
        // return a random Color with any possble value 
        // this returns a Color with random decimal values for red, green, blue, and alpha (opacity)
        // beteen 0.0 and 1.0
    ...
    public ShapeList() {
        ...
        super();
        // add 10 random Shape objects to the list
        for (int i = 0; i < 10; i++) {
    ...
    // if we try to instantiate an abstrat class, we get an error 
    // because abstract classes can only be extended 
    ...
    // add a toString() method to returna String representation of the list
        @Override 
